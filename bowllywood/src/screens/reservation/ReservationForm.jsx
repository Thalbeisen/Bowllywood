...
function ReservationDetail ({ action='ADD' }) {
	...
	return (
		<div className="resCtnr d-flex flex-column px-5 py-4">
			...
			<form onSubmit={handleSubmit} className="resForm row align-items-center flex-column ps-5 ms-1">
				{
					(!editMode)
					? <Col xs={12} md={7} className="ps-4 mb-5">
						<h2 className="m-0">Ajout d'une réservation</h2>
					</Col>
					: <Col xs={12} md={7} className="ps-2 mb-5">
...

				{
					...
					<Col xs={12} sm={11} md={10} lg={8} xl={7} xxl={6} xxxl={5} className="px-0 mt-5">
